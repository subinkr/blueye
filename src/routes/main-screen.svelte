...
<div class="relative h-[calc(100vh-80px)] w-full">
  <img class='absolute inset-0 w-full h-full object-cover object-center' alt="블루아이 배경화면" src="/images/apartment.png" />
  <div class="w-full flex flex-col justify-center items-center text-center absolute h-[calc(100vh-80px)] bg-white/80 dark:bg-black/80">
    <div class="mb-12">
      <Heading tag="h2" class="w-[80vw] text-black dark:text-white text-wrap" customSize="text-xl font-extrabold sm:text-2xl md:text-3xl lg:text-4xl ">진정성으로 승부하는</Heading>
    ...
    <div class="mb-12">
      {#if visible}
        <p class="w-[80vw] text-left sm:text-lg lg:text-xl sm:px-16 xl:px-48 text-black dark:text-white" transition:typewriter>
          블루아이는 상품의 가치(안정성과 수익성) 뿐만 아니라 프로젝트 완료 후에도 끝까지 고객님들의 상품을 관리하고 재판매를 이어온 부동산 브랜드입니다.
