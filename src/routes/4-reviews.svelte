<script>
  ...
  const reviews =[
      ...
      {title: "52세 여성", detail: "말레이시아 이민", region: "말레이시아 조호바루", building: "Macrolink", content: "말레이시아 부동산 시장에 관심이 있었지만 정보가 부족해서 망설이고 있었습니다. 블루아이를 통해 상세한 시장 분석과 투자의 장단점을 알 수 있었고, 현지 지사의 도움으로 복잡한 절차도 쉽게 진행할 수 있었습니다.",},
