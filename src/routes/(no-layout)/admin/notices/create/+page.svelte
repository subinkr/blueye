  ...
  <div class="w-full mx-auto py-4">
    ...
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center space-x-4">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">공지사항 작성</h1>
      </div>
    ...
    <form id="notice-form" method="post" action="?/create" use:enhance>
      <div class="space-y-4">
        <!-- 제목 입력 -->
