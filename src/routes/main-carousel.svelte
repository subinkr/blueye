<script>
  ...
  import { bodyHeight } from '$lib/scroll-control.ts';
	...
	const images = [
    {
      ...
      title: "해외 부동산 투자 블루아이와 함께라면 23년의 노하우가 함께합니다.",
      content: "30,000건의 매매 거래로 증명된 신뢰와 전문성 3,500명의 고객이 증명한 성공적인 해외 투자 파트너",
      content1: "30,000건의 매매 거래로 증명된 신뢰와 전문성",
      content2: "3,500명의 고객이 증명한 성공적인 해외 투자 파트너",
  ...
  //   {
  //     alt: '싱가포르',
  //     src: '/images/main/singapore.jpg',
  //     // portrait_src: '/images/main/singapore.jpg',
  //     title: "풍요로운 아시아 라이프",
  ...
  //   {
  //     alt: '호치민',
  //     src: '/images/main/ho-chi-minh-city.jpg',
  //     // portrait_src: '/images/main/ho-chi-minh-city.jpg',
  //     title: "Global Real Estate Academy",
...
{#each images as image, index (index)}
    <a class={"w-full h-full relative"} href="/">
      <div class={"px-4 z-10 absolute top-32 left-0.5 right-0.5 sm:top-40 lg:right-40 lg:left-auto text-center lg:text-right flex flex-col gap-10 " + image.textColor}>
...
<!-- <div class="w-full">
  ...
  {#each images as image, index (index)}
    ...
    <span class="text-white" slot="right-control"><AngleRightOutline size="xl" strokeWidth="2" /></span>
  </Carousel>
</div> -->