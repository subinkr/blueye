...
<div class="w-full h-64 bg-primary-700 flex flex-col gap-4 justify-end items-center">
  ...
  <div class="w-full sm:w-9/12 h-1/3 bg-white dark:bg-gray-900 flex justify-center items-center gap-4 sm:gap-8 rounded-t-lg">
